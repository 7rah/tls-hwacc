...
static int test_aes(int cfd)
{
	...
	char ciphertext1[AES_BLOCK_SIZE] = { 0x66, 0xe9, 0x4b, 0xd4, 0xef, 0x8a, 0x2c, 0x3b, 0x88, 0x4c, 0xfa, 0x59, 0xca, 0x34, 0x2b, 0x2e };
	...
	if (memcmp(plaintext1, ciphertext1, AES_BLOCK_SIZE) != 0) {
		fprintf(stderr,
			"FAIL1: Decrypted data are different from the input data.\n");
		return -1;
	}
